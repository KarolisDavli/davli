        ...
        >
          ...
          >
            <VStack spacing="16px" alignItems="left">
              <Box textStyle="h1">Support Labs</Box>
              <Text maxW="600px">
                Support Labs - digital marketing company focusing on google ads.
                I was responsible for creating brand identity, designing and
                developing website.
              </Text>
            </VStack>
          </motion.div>
        ...
        >
          ...
          >
            ...
            <Box display="flex" justifyContent="center">
              <Image
                borderRadius="1.5rem"
                src="/projects/suplabs/small.png"
                alt="Sanjow project image"
              />
            </Box>
          </Box>
      ...
      <Container maxW="container.lg" mt={{base: "10", md: "20"}}>
        ...
        >
          <Box display="flex" justifyContent="center">
            <Image
              borderRadius="1.5rem"
              src="/projects/suplabs/Frame 9.jpg"
              alt="Sanjow project image"
            />
          </Box>
        </motion.div>
